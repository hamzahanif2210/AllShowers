...
ML_DIR = "/n/home04/hhanif/AllShowers/results/20260718_010354_Electrons/"

# (filename, legend label, color)
ML_FILES = [
    ("sweep_ig1_samples00.h5", "No internal guidance",  "#ff7f0e", "s"),
    ("sweep_ig1p1_samples00.h5", "Internal guidance (ig_scale=1.1)", "#2ca02c", "^"),
    ("sweep_ig1p4_samples00.h5", "Internal guidance (ig_scale=1.4)",      "#d62728", "D"),
    ("sweep_ig1p8_samples00.h5", "Internal guidance (ig_scale=1.8)",     "#9467bd", "v"),
    ("sweep_ig2p3_samples00.h5", "Internal guidance (ig_scale=2.3)",     "#9467bd", "v"),
...
ml_data = []
for fname, label, color, marker in ML_FILES:
    print(f"Loading ML: {label} ...")
    pts, pdg, ncols = load_file(ML_DIR + fname)
    ml_data.append({
        "label": label,
        "color": color,
        "marker": marker,
...
out = "/n/holylfs05/LABS/arguelles_delgado_lab/Everyone/hhanif/tambo_simulations_for_training/h5_files_v3/shower_observables_multi_ml_comparison.pdf"
